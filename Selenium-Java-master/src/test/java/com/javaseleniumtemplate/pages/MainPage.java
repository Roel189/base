...
public class MainPage extends PageBase {
    ...
    By logoutButton = By.xpath("//*[@id='navbar-container']/div[2]/ul/li[2]/ul/li[4]/a/text()");
    By reportedByMe = By.xpath("//*[@id='reported']/div[1]/div[2]/div/a");
    ...
    public void clickReportedByMe(){click(reportedByMe);}
